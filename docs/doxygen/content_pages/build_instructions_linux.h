...
/**
 ...
 \page build_instructions_linux Ubuntu 22.04 Build Instructions for MATHLIB
...
builds), delete build folder before rebuilding
 ...
 \par Run
  ...
  - To run MATHLIB kernels on a PC:
    - \code bin/Release/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode OR \code
bin/Debug/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode
      - Ex: \code bin/Release/test_MATHLIB_tan_C7100_x86_64 \endcode
...
builds), delete build folder before rebuilding
 ...
 \par Run
  ...
  - To run MATHLIB kernels on a PC:
    - \code bin/Release/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode OR \code
bin/Debug/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode
      - Ex: \code bin/Release/test_MATHLIB_tan_C7120_x86_64 \endcode
  - To run MATHLIB kernels for target
    - To reproduce numbers given in the datasheet, run the .out program on the EVM in No Boot Mode
...
builds), delete build folder before rebuilding
 ...
 \par Run
  ...
  - To run MATHLIB kernels on a PC:
    - \code bin/Release/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode OR \code
bin/Debug/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode
      - Ex: \code bin/Release/test_MATHLIB_tan_C7504_x86_64 \endcode
  - To run MATHLIB kernels for target
    - To reproduce numbers given in the datasheet, run the .out program on the EVM in No Boot Mode
...
/**
 ...
 \par Build
  ...
  - Build options:
    ...
    - AUTO_TEST=1/0 (builds all test cases and libraries)
  - Example CMake commands
    - To build MATHLIB_sqrt for target on j722s and run performance test cases:
      - \code cmake -B build -DTARGET_PLATFORM="" -DBUILD_TEST="1" -DKERNEL_NAME="MATHLIB_sqrt" -DSOC="j722s" \
-DDEVICE="C7524" -DMATHLIB_DEBUGPRINT="0" -DALL_TEST_CASES="1" -DCMAKE_EXPORT_COMPILE_COMMANDS="TRUE" \
-DCMAKE_BUILD_TYPE="Release" \endcode
    - To build MATHLIB_div for host emulation on j722s and run example code
      - \code cmake -B build -DTARGET_PLATFORM="PC" -DBUILD_EXAMPLE="1" -DKERNEL_NAME="MATHLIB_div" \
-DSOC="j722s" -DDEVICE="C7524" -DMATHLIB_DEBUGPRINT="0" -DCMAKE_EXPORT_COMPILE_COMMANDS="TRUE" \
-DCMAKE_BUILD_TYPE="Release" \endcode
    - To build MATHLIB_exp for host emulation on j722s and run test case 2 with debug print statements
        - \code cmake -B build -DTARGET_PLATFORM="PC" -DBUILD_TEST="1" -DKERNEL_NAME="MATHLIB_exp" -DSOC="j722s" \
-DDEVICE="C7524" -DMATHLIB_DEBUGPRINT="1" -DTEST_CASE="2" -DCMAKE_EXPORT_COMPILE_COMMANDS="TRUE" \
-DCMAKE_BUILD_TYPE="Release" \endcode
...
builds), delete build folder before rebuilding
 ...
 \par Run
  ...
  - To run MATHLIB kernels on a PC:
    - \code bin/Release/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode OR \code
bin/Debug/test_MATHLIB_<kernel_name>_<device>_x86_64 \endcode
      - Ex: \code bin/Release/test_MATHLIB_tan_C7524_x86_64 \endcode
  - To run MATHLIB kernels for target
    - To reproduce numbers given in the datasheet, run the .out program on the EVM in No Boot Mode
